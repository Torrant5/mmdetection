...
# Custom dataset (images variant) for fine-tuning YOLOX-Tiny
...
# Keep 80 classes to align with COCO pretrained weights
...
# Shorten schedule for quick fine-tuning (override in CLI via train script)
max_epochs = 20
num_last_epochs = 5
interval = 5
